...
describe('Email Templates', () => {
  ...
  describe('generateAdminCustomEmail', () => {
    const adminEmailData: AdminCustomEmailData = {
      ...
      customMessage:
        'We need to inform you about a delay in your order.\\nPlease contact us if you have questions.',
    ...
    it('should handle multiline messages', () => {
      ...
      expect(html).toContain(
        '<p style="margin: 0 0 12px 0;">We need to inform you about a delay in your order.</p>',
      )
      expect(html).toContain(
        '<p style="margin: 0 0 12px 0;">Please contact us if you have questions.</p>',
      )
    })
